...
最後一個小插曲我特別喜歡：回家之後，我用 M5 Cardputer（一台超迷你的掌上電腦），加上 Claude 幫我寫的一個 skill，做了一隻 Claude 寵物——一隻電子雞。忙了一整天聽各種「AI 怎麼改變開發」，結果回家做的第一件事，是讓 AI 幫我養一隻數位寵物。
